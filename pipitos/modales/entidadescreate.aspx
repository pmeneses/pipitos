<%@ Page Language="C#" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="entidadescreate.aspx.cs" Inherits="pipitos.modales.entidadescreate" %>
...
<body>
   <form runat="server">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Agregar entidades</h5>
                <hr />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="cbdonantes">Categoria donante:</label>
                            <asp:DropDownList runat="server" ID="cbcategoria" CssClass="form-control form-control-sm"/>
