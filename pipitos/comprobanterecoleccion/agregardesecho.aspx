<%@ Page Language="C#" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="agregardesecho.aspx.cs" Inherits="pipitos.comprobanterecoleccion.agregardesecho" %>
...
<html lang="en">
    ...
    <body>
        ...
        <asp:HiddenField ID="idrecolecta" runat="server" />
        <asp:HiddenField ID="idmaterial" runat="server" />
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <h5>Material: <span class="badge badge-primary" runat="server" id="lbmaterial"></span></h5>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
